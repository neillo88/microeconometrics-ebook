...
*ceteris paribus* **in expectation**.
...
-   Randomization **does not** allow us to learn about $f_{Y(1),Y(0)}$
    or $f_{Y(1)-Y(0)}$

Example from Banerjee *et al.* (2015, p. 38) [^1]
![](Images/Banerjee_p38.png)

[^1]: Banerjee, A., Duflo, E., Glennerster, R. & Kinnan, C. 2015, "The
...
commonly referred to as **Randomized Control Trials (RCTs)**.
...
-   Unfortunately, randomization is not always feasible, it can be
    ...
    -   Rely on the design and implementation of policies to exploit
        other research designs: difference-in-differences, regression
        discontinuity designs.
-   Useful lens through which to approach a research question?
    -   For example, what is the impact of attending an Ivy-league
        school?
...
From Imbens and Wooldridge (2009, p.23)[^2],

[^2]: Imbens, G.W. & Wooldridge, J.M. 2009, "Recent Developments in the
...
For example, (Oreopoulus, 2011, p.158)[^3]

[^3]: Oreopoulos, P. 2011, "Why Do Skilled Immigrants Struggle in the
...
[VA]{style="color : blue"}riance) test.[^4]

[^4]: Common Alternatives include Multivariate ANOVA (MANOVA) and
    Analysis of Covariance (ANCOVA)

-   Decomposes TSS into,[^5]

[^5]: Check your EC124 notes on this.
...
For example, Dupas and Robinson (2013, p.1150)[^6]

[^6]: Dupas, P. & Robinson, J. 2013, "Why Don't the Poor Save More?
...
Since $\bar{W}=\frac{N_t}{N}$, we can show that [^7]

[^7]: Do ensure that you can show this.
...
[^8]: Here I am avoiding finite sample notation. This is not a big issue
...
[^9]: Deaton, A. 2010, "Instruments, Randomization, and Learning about
...
estimator of $\tau_{ATE}$.[^10]

[^10]: Focus on the intuition of the results, not the equation. Taken
...
Here are the estimators:[^11]

[^11]: Subject of first seminar.
...
The question of good and bad controls is **very** important.[^12]
...
[^13]: Here I am being more general over the choice of the estimator
    $\hat{\tau}$ and I am approximating the distribution of the
    test-statistic with the standard normal.
...
Evaluation]{style="color: blue"}[^14]'

[^14]: [Banerjee, A., Duflo, E., Glennerster, R. & Kinnan, C. 2015, "The
    Miracle of Microfinance? Evidence from a Randomized Evaluation",
    American economic journal. Applied economics, vol. 7, no. 1, pp.
...
[^15]: *More generally used in discussion of non-compliance.*
...
[^16]: I have use the authors' notation.
