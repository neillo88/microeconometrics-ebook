1.  Difference-in-Differences - Static
    ...
    **Card & Krueger (AER, 1994)** is a seminal paper in this literature[^paralleltrends-11],
    ...
    ![](docs/images/diff-card-krueger-1994-tab1.png)

    ![](docs/images/diff-card-krueger-1994-fig1.png)
    ...
    ![](docs/images/diff-card-krueger-1994-tab3.png)\
    \
    Conclusion,
    ...
    **QUESTION:** Assuming parallel trends and all necessary exclusion restrictions, how would we define ( $\beta_2$ )?
    ...
    ::: details
    ::: {.summary title="Click to see the proof"}
    ...
    **Assuming no pre-emptive behaviour**, the test,
    ...
    ## Example: [Eissa & Liebman (1996)](https://www.nber.org/papers/w5158)
    ...
    **Figure**: The tax credit is 40% of earned income for the first \$14570 ([2019 parameters](https://www.cbpp.org/research/policy-basics-the-earned-income-tax-credit) based on single earner with two children)

    ...at which point it is flat up to a second threshold...

    ![](docs/images/EL2.png)

    **Figure**: The maximum is \$5828 ([2019 parameters](https://www.cbpp.org/research/policy-basics-the-earned-income-tax-credit) based on single earner with two children)
...
**Figure**: The phase out rate is 21.06% which ends at \$46703 ([2019 parameters](https://www.cbpp.org/research/policy-basics-the-earned-income-tax-credit) based on single earner with two children)
